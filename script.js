...
const translations = {
  "ru": {
    ...
    "rankingLead": "Постоянный рейтинг хранит всю историю, а сезонный обнуляется каждый месяц и определяет победителей сезона.",
    ...
    "permanentRule1Text": "При N игроках первое место получает +N ELO, а последнее +1. Одинаковый скор даёт одинаковое место и ELO.",
    "permanentRule2Title": "Отдельные бонусы ивентов",
    "permanentRule2Text": "Если ивент заранее объявил бонус постоянного ELO, он добавляется отдельно.",
    ...
    "seasonRule1Text": "От +N за 1-е место до +1 за последнее.",
    "seasonRule2Title": "Место по accuracy",
    "seasonRule2Text": "Ещё одна таблица N..1, но уже по точности.",
    "seasonRule3Title": "Прогресс места",
    "seasonRule3Text": "Лучше прошлого матча: +1. Хуже: −1. Так же: 0. Доли сравниваются честно: 3/5 = 2/3.",
    "seasonRule4Title": "Время в игре",
    "seasonRule4Text": "Каждые накопленные 5 минут завершённых матчей: +1 ELO.",
    "seasonRule5Title": "Участие в ивенте",
    "seasonRule5Text": "Результат в объявленном ивент-матче: +1 ELO.",
    "seasonPrizeTitle": "😎 Топ 5 получают osu!supporter",
    "seasonPrizeText": "По 1 месяцу в конце сезона.",
    "seasonEligibility": "Для допуска бот проверяет 2 лучших osu!standard результата. Результат на карте 6.70★ или выше исключает только из сезона — постоянный рейтинг остаётся доступен.",
  ...
  "en": {
    ...
    "rankingLead": "The permanent ranking keeps your entire history, while the seasonal ranking resets every month and determines the season winners.",
    ...
    "permanentRule1Text": "With N players, 1st place earns +N ELO and last place earns +1. Equal scores share the same place and ELO reward.",
    "permanentRule2Title": "Separate event bonuses",
    "permanentRule2Text": "If an event announces a permanent ELO bonus in advance, it is added separately.",
    ...
    "seasonRule2Title": "Accuracy placement",
    "seasonRule2Text": "A second N..1 table, ranked by accuracy instead.",
    "seasonRule3Title": "Placement progress",
    "seasonRule3Text": "Better than last match: +1. Worse: −1. Equivalent: 0. Proportions are compared fairly: 3/5 = 2/3.",
    "seasonRule4Title": "Time played",
    "seasonRule4Text": "Every accumulated 5 minutes across completed matches: +1 ELO.",
    "seasonRule5Title": "Event participation",
    "seasonRule5Text": "Recording a result in an announced event match: +1 ELO.",
    "seasonPrizeTitle": "😎 Top 5 receive osu!supporter",
    "seasonPrizeText": "One month each at the end of the season.",
    "seasonEligibility": "To qualify, the bot checks your 2 best osu!standard scores. A result on a 6.70★ or harder map excludes you only from the season — the permanent ranking remains available.",
    "copied": "Copied: {cmd}",
